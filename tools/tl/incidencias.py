...
CATALOGO: list[dict] = [
    ...
    {"id": "lint_revertido", "patron": r"renpy lint: (\d+) línea", "accion": None, "reintentar": False,
     "causa": "Una o más líneas traducidas rompían la sintaxis de Ren'Py; la puerta de lint las devolvió al inglés y el juego arranca.",
     "que_hacer": "Nada urgente: esas líneas quedaron en inglés. Están listadas en Revisión y QA; si quieres, corrígelas a mano en game/tl/spanish/ y vuelve a empaquetar."},
    ...
    {"id": "renpy_version", "patron": r"expected statement|is not a keyword|renpy\.sh translate spanish fallo", "accion": None, "reintentar": False,
     "causa": "El SDK de Ren'Py disponible no entiende la sintaxis del juego (el juego usa un Ren'Py más nuevo que el SDK).",
     "que_hacer": "Instalar el SDK de la versión del juego en ~/apps/renpy-<versión>-sdk (renpy.org/dl); el pipeline elige el SDK por la versión que trae el juego en renpy/vc_version.py."},
    {"id": "unrpyc", "patron": r"unrpyc (fall|error)|decompil\w* fall|no se pudo decompilar", "accion": None, "reintentar": False,
